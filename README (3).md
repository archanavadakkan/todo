...
Todo task adding program 
Program to add task,
Views added task,
Delete added task 

Todo list project is an application specially built to keep track of errands or tasks that need to be done.
...
## 🛠 Skills
Python, Django, HTML, TKinter,MySQL, REST API, PostgreSQL, CSS...
